...
var grammar = {
    ...
    {"name": "location$subexpression$1$string$1", "symbols": [{"literal":"a"}, {"literal":"n"}, {"literal":"d"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "location$subexpression$1", "symbols": ["location$subexpression$1$string$1"]},
    {"name": "location", "symbols": ["between", "entity", "location$subexpression$1", "entity"], "postprocess": R({relation:0, entity:1, entity2:3})},
